...
* Over the lifetime of a product, this will deliver higher quality at lower cost than developing your own.
* Recognise that skills and experience with these solutions benefit the industry as a whole.
* Accept that these solutions require financial support to be sustainable.

Don't roll your own. Use what works.

## [Transferable Skills](/public/messaging/stakeholders/individual-developers.md#developing-transferable-and-in-demand-knowledge-and-skills)
...
[contribute to the discussion](https://github.com/orgs/UseWhatWorks/discussions/2)

## Consolidated Improvement

"Given enough eyeballs, all bugs are shallow" *([Linus's Law](https://en.wikipedia.org/wiki/Linus%27s_law))*

Deploying software across a wide range of scales and scenarios yields feedback,
metrics, and insights that lead to higher quality. Improvements and bug fixes benefit everybody who uses that software.

[contribute to the Discussion](https://github.com/orgs/UseWhatWorks/discussions/3)
...
[contribute to the discussion](https://github.com/orgs/UseWhatWorks/discussions/4)
